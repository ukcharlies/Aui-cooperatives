...
const DashboardPage = () => {
  return (
    <div className="max-w-4xl mx-auto p-4 ml-64 w-full bg-green-400">
      <div className="bg-white rounded-lg shadow-lg mb-4 p-6 flex justify-between items-center">
        ...
        <div className="flex items-center">
          ...
          <div>
            ...
            <span className="text-sm text-gray-600 border border-gray-400 rounded-full px-2 py-1 mt-1 inline-block">Gold Member</span>
          </div>
        </div>
        {/* Total savings */}
